/**
 * Created by WackobytesApp on 8/23/14.
 */
 ...
 * @author Aymeric
 */
public class PutTogeherGameState extends StarlingState {

    public function PutTogeherGameState() {
    ...
    [Embed(source="/embed/particlePicked.xml", mimeType="application/octet-stream")]
    private var _particlePickedConfig:Class;
    [Embed(source="/embed/particlePicked.png")]
    private var _particlePickedPng:Class;
